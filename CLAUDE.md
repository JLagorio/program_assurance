...
- **The design system** (`packages/design-system`, published name `@ledger/design-system`, "Ledger"): tokens, primitives, components, layout, patterns and colour mode. Its Storybook is the contract. Read `packages/design-system/README.md` and `docs/guides/component-library.md` before touching it.
