...
- **Repo is NOT a git repository** (lives in ~/Downloads). Durable-set commits are skipped; offer `git init` at the end of a run.
...
- **`src/components/ui/` (46 shadcn files) is unused Lovable scaffolding** — zero imports anywhere in the app. Deliberately excluded from the DS (user confirmed 2026-08-28).
