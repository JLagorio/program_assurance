...
- **The peek is a Sheet; the panel is the record's rail.** Josef's clarification: the preview
  slides over the page and the nav to about half the screen and stays a Sheet. On a record the
