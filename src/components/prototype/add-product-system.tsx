...
function VariantDialog({
  ...
  return (
    ...
    >
      <DialogContent style={{ maxWidth: 720 }} showCloseButton={!add.isPending}>
        <DialogHeader>
          <DialogTitle>Add system from a product</DialogTitle>
          <DialogDescription>
        ...
        <DialogFooter>
          <Button variant="subtle" disabled={add.isPending} onClick={onClose}>
            Cancel
          </Button>
          <Button
            variant="primary"
