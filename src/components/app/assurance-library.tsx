  ...
  return (
    <>
      <Stack space="space.200" className="min-w-0">
        ...
        <Inline className="flex-wrap gap-100">
          <>
...
export function AssuranceLibraryRecord({
  ...
  if (!current)
    return (
      <PageHeader>
        <div className="min-w-0">
          <PageHeader.Title>{`${entry.name} · Version not found`}</PageHeader.Title>
        </div>
      </PageHeader>
    );
    ...
    <>
      <Stack space="space.200" className="min-w-0">
        <PageHeader>
          ...
          <div className="min-w-0">
            <PageHeader.Title>{entry.name}</PageHeader.Title>
            <Inline
              space="space.100"
              alignBlock="center"
              shouldWrap
              className="pt-050 font-body-small text-subtle"
            >{`${entry.category} · ${current.version} · ${entry.owner}`}</Inline>
          </div>
          <PageHeader.Actions>
            <>
              ...
              {editable ? (
                <Button
                  ...
                  onClick={() => {
                    ...
                    if (runLibraryAction(() => publishLibraryDraft(entry.id), "Version published"))
        ...
        <Tabs value={tab} onValueChange={selectTab} className="gap-150">
                  ...
                  <Table style={{ minWidth: 700 }}>
                    ...
                    <tbody>
                      ...
                      {!current.requirements.length && (
                        <EmptyRow columns={5}>No requirements</EmptyRow>
                      )}
                    </tbody>
                  </Table>
                </Section>
              ...
              <>
                ...
                <Inspector.Group title="Coverage">
                  ...
                  <KeyValue label="Not applicable">
                    {
                      current.controls.filter(
                        (control) => control.applicability === "Not applicable",
                      ).length
                    }
                  </KeyValue>
                </Inspector.Group>
