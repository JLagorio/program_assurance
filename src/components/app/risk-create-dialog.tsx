...
export function CreateRiskDialog({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <Dialog
      ...
      width="large"
      title="Create a risk"
      description="Score the initial risk from likelihood × impact. Saved records and drafts stay in this browser."
      aside={
        <div>
          ...
          <p className="pt-150 font-body-small text-subtle">
            The initial residual score equals the inherent score until a treatment is assessed.
          </p>
        </div>
      }
      footer={
        <>
          ...
          <Button variant="primary" type="submit" form={formId} disabled={form.state.isSubmitting}>
            Create risk
          </Button>
        </>
      }
