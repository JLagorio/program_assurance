...
export type ControlFamilyId = "AC" | "AU" | "CM" | "IA" | "RA" | "SC" | "SI" | "SR";
...
export const controls: Control[] = [
  ...
  },
  {
    id: "AC-17(2)",
    family: "AC",
    title: "Remote access | protection of confidentiality",
    baseline: ["Moderate", "High"],
    addedBy: ["OVL-TAC"],
    cciCount: 2,
  },
...
export const overlays: Overlay[] = [
  {
    ...
    authority: "CNSSI 1253 App. F Att. 5",
    applicability: "Systems processing collateral SECRET and above",
    adds: 41,
    removes: 0,
    parameters: 18,
  },
  {
    id: "OVL-TAC",
    name: "Tactical / DDIL",
    authority: "CNSSI 1253 App. K",
    applicability: "Disconnected, intermittent, limited-bandwidth edge systems",
    adds: 12,
    removes: 9,
    parameters: 22,
  },
  {
    id: "OVL-SPC",
    name: "Space platform",
    authority: "CNSSI 1253 App. F Att. 2",
    applicability: "On-orbit segments and ground control",
    adds: 17,
    removes: 4,
    parameters: 11,
  },
  {
    ...
    authority: "Service overlay",
    applicability: "Systems with a loss-of-life failure mode",
    adds: 23,
    removes: 0,
    parameters: 14,
  },
  {
    id: "OVL-IL5",
    name: "DoD IL5 cloud",
    authority: "DoD CC SRG",
    applicability: "Mission-owner workloads on an IL5 CSO",
    adds: 8,
    removes: 2,
    parameters: 9,
  },
...
export const benchmarks: Benchmark[] = [
  ...
  {
    id: "BM-ASD",
    name: "Application Security & Development SRG",
  ...
  {
    id: "BM-CISCO",
    name: "Cisco IOS XE Router NDM STIG",
...
export const rules: Rule[] = [
  {
    id: "V-222387",
    benchmark: "BM-ASD",
    title: "The application must provide automated mechanisms for account management.",
    severity: "CAT II",
    ccis: ["CCI-000015"],
  },
  {
    id: "V-230234",
    benchmark: "BM-RHEL9",
    title: "RHEL 9 must audit all account creations.",
    severity: "CAT II",
    ccis: ["CCI-000015", "CCI-000018"],
  },
  {
    id: "V-230235",
    benchmark: "BM-RHEL9",
    title: "RHEL 9 must disable account identifiers after 35 days of inactivity.",
    severity: "CAT III",
    ccis: ["CCI-001361"],
  },
  {
    id: "V-230386",
    benchmark: "BM-RHEL9",
    title: "RHEL 9 must audit all uses of the execve system call.",
    severity: "CAT II",
    ccis: ["CCI-000172"],
  },
  {
  ...
  },
  {
    id: "V-222397",
    benchmark: "BM-ASD",
    title: "The application must use FIPS-validated cryptography for remote sessions.",
    severity: "CAT I",
    ccis: ["CCI-000068"],
  },
  {
    id: "V-230396",
    benchmark: "BM-RHEL9",
    title: "RHEL 9 audit records must contain the event type.",
    severity: "CAT III",
    ccis: ["CCI-000130"],
  },
  {
    id: "V-230401",
    benchmark: "BM-RHEL9",
    title: "RHEL 9 audit logs must be owned by root.",
    severity: "CAT II",
    ccis: ["CCI-000162"],
  },
  {
    id: "V-222440",
    benchmark: "BM-ASD",
    title: "The application must protect audit information from unauthorized read access.",
    severity: "CAT II",
    ccis: ["CCI-000162"],
  },
  {
  ...
  },
  {
    id: "V-222501",
    benchmark: "BM-K8S",
    title: "Kubernetes must disable anonymous authentication to the API server.",
    severity: "CAT I",
    ccis: ["CCI-000366"],
  },
  {
    id: "V-230522",
    benchmark: "BM-RHEL9",
    title: "RHEL 9 must employ a deny-all, permit-by-exception execution policy.",
    severity: "CAT II",
    ccis: ["CCI-001774"],
  },
  {
    id: "V-222390",
    benchmark: "BM-ASD",
    title: "The application must use multifactor authentication for privileged accounts.",
    severity: "CAT I",
    ccis: ["CCI-000765"],
  },
  {
    id: "V-230357",
    benchmark: "BM-RHEL9",
    title: "RHEL 9 passwords must enforce character class requirements.",
    severity: "CAT II",
    ccis: ["CCI-000192"],
  },
  {
    id: "V-222577",
    benchmark: "BM-ASD",
    title: "The application must implement TLS 1.2 or greater for all transmitted data.",
    severity: "CAT I",
    ccis: ["CCI-002418"],
  },
  {
    id: "V-230529",
    benchmark: "BM-NGINX",
    title: "The web server must disable TLS renegotiation and legacy ciphers.",
    severity: "CAT II",
    ccis: ["CCI-002418"],
  },
  {
  ...
  },
  {
    id: "V-230262",
    benchmark: "BM-RHEL9",
    title: "RHEL 9 must install security-relevant updates within the defined period.",
    severity: "CAT II",
    ccis: ["CCI-002605"],
  },
  {
    id: "V-222604",
    benchmark: "BM-K8S",
    title: "Kubernetes must monitor and audit inbound and outbound API traffic.",
    severity: "CAT II",
    ccis: ["CCI-002656"],
  },
];
