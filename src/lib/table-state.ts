...
/* Column sort for a table: one key at a time, click the same header again to
   flip. `get` names the value each sortable column reads off a row; keep it at
   module level so the memo holds. */
...
/* One page of a list. The page number clamps when the list shrinks. */
