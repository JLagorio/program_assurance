...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    // Apply the stored colour mode and row density before the first paint; the providers take over after mount.
    scripts: [{ children: modeScript }, { children: densityScript }],
    links: [
      {
        rel: "stylesheet",
        href: appCss,
