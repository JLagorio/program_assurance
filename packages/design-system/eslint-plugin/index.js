...
const structural = [
  ...
  /^(grid-cols-main-rail|grid-cols-list-detail|sticky-rail|sticky-bar|stagger-children|min-h-work|shell-(root|banner|topnav|topnav-start|sidenav|sidenav-overlay|main|panel))$/, // layout.css, on the layout dimension tokens
