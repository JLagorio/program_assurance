...
const config: StorybookConfig = {
  ...
  addons: [// GFM tables in MDX are opt-in since Storybook 8.
  { name: "@storybook/addon-docs", options: { mdxPluginOptions: { mdxCompileOptions: { remarkPlugins: [remarkGfm] } } } }, "@storybook/addon-a11y", "@storybook/addon-vitest", "@storybook/addon-mcp"],
  typescript: {
