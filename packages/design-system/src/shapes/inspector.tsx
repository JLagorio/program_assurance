...
/** Facts that stay put: sticky under the top bar, always present, every group open until the reader folds it. */
...
function InspectorGroup({ title, children, action }: { title: string; children: ReactNode; action?: ReactNode }) {
  return (
