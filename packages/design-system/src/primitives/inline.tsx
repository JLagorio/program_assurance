import { Children, Fragment, type ComponentPropsWithoutRef, type ElementType, type ReactNode, type Ref } from "react";

import { cn } from "../lib/cn";
import { spaceClasses, type SpaceToken } from "./tokens";

const alignBlock = { start: "items-start", center: "items-center", end: "items-end", baseline: "items-baseline", stretch: "items-stretch" } as const;
const alignInline = { start: "justify-start", center: "justify-center", end: "justify-end" } as const;
...
export function Inline({ as: Tag = "div", space, rowSpace, alignBlock: ab, alignInline: ai, spread, shouldWrap, separator, grow, className, children, ...rest }: InlineProps) {
