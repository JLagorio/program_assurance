          ...
          <Stack key={t} space="space.050" alignInline="center">
            ...
            >
              <Box
                ...
                className="size-icon-medium rounded-small"
              />
            </Box>
    ...
    <Inline space="space.300" alignBlock="stretch">
      {(
        ...
        <Box
          ...
          padding="space.200"
          className={
            s === "elevation.surface.raised"
              ? "rounded-large shadow-raised"
              : s === "elevation.surface.overlay"
                ? "rounded-large shadow-overlay"
                : "rounded-large border border-default"
          }
        >
          <Stack space="space.100">
            ...
            <Box
              ...
              padding="space.100"
              className="rounded-small border border-default"
            >
      ...
      {(
        ...
        >
          <Text
            size="small"
            color={
              b.includes("bold") && !b.includes("warning") ? "color.text.inverse" : "color.text"
            }
          >
            {b.replace("color.background.", "")}
          </Text>
        </Box>
      ))}
    </Inline>
