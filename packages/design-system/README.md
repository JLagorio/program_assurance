...
IndexPage, ShowPage, RecordHeader, PreviewRail, PreviewSplit, standalone Panel and Block are removed. PageHeader is composable; Section is optional, accepts native props/refs and has an opt-in border. Use Sheet for modal work. Layout and patterns have separate Storybook categories.
